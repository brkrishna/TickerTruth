...
class AdjustmentValidator:
    def validate_against_lineage(adjustments: pd.DataFrame,
                                 lineage: pd.DataFrame) -> pd.DataFrame:
    ...
    def validate_against_price_gaps(adjustments: pd.DataFrame,
                                   eod_prices: pd.DataFrame) -> pd.DataFrame:
